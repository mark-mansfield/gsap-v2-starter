...
const MatchIdV1 = props => {
  ...
  const { animation, homeTeamLogo, awayTeamLogo, ad_assets } = props;
  ...
  const panelTimeline = (left, right) => {
    ...
    tl.from(left, 0.7, {
      ...
      .from(right, 0.7, { scaleX: 0, transformOrigin: '0% 50%' }, '-=0.7')
  ...
  useEffect(() => {
    ...
    const defaultAnimation = animation.find(({ animation }) => animation === 'matchIdV1');
    ...
    <div>
      <svg width="1000" height="1000" viewBox="0 0 1000 900" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g ref={e => (leftPanel = e)} id="left-panel" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <rect stroke="none" fill="black" x="0" y="60" width="500px" height="700px"></rect>
          <text ref={e => (homeTeamName = e)} className="large-text bold upper-case" fill="#e8e64e" x="7%" y="80%">
            Mounties Wanderers
          </text>
        </g>

        <g ref={e => (rightPanel = e)} id="right-panel" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <rect stroke="none" fill="#e8e64e" x="500" y="60" width="500px" height="700px"></rect>
          <text ref={e => (awayTeamName = e)} className="large-text bold upper-case" fill="#000" x="66%" y="80%">
            GHFA SPIRIT
          </text>
        </g>
