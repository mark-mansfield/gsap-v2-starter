...
const MatchIdV4 = props => {
  ...
  const panelTimeline = (left, right) => {
    ...
    tl.from(left, 0.7, {
      ...
      .from(right, 0.7, { scale: 0, transformOrigin: '100% 0%' }, '-=0.7')
  ...
  useEffect(() => {
    ...
    const defaultAnimation = animation.find(({ animation }) => animation === 'matchIdV4');
    ...
    <div>
      <svg width="1000" height="1000" viewBox="0 0 1000 900" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <g ref={e => (rightPanel = e)} id="right-panel" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <rect stroke={awayTeamColor} fill={awayTeamColor} x="500" y="60" width="500px" height="700px"></rect>
          <text
